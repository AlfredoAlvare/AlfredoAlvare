        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                  <h1>Registro de usuarios <small class="tittles-pages-logo">Mochilas Ixtapaluca</small></h1>
                </div>
                <div class="col-xs-12 col-sm-6 text-center">
                   <br><br><br>
                    ...
                    <br>
                    <center>
                    <img src="assets/img/puma.png" alt="electrodomesticos" class="img-responsive">
                    </center>
                </div>
